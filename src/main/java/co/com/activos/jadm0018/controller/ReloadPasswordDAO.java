...
import co.com.activos.jadm0018.util.OracleFactory;
import oracle.jdbc.OracleTypes;
import co.com.activos.jadm0018.interfaces.ReloadPasswordInterface;
...
//            ystem.out.println("Peticion Registrada");
    ...
    public void sendMail(String destino, String para, String asunto, String contenido) {
        ...
        try {
            ...
            if (error != null) {
                System.out.println("Error:JADM0018 sendMail"+error);
            }
            conexion.close();
